 ...
 */
public class GrossSalesViewDO implements Serializable {
	...
	private String pzh;
	//单位实际成本
	private String dwsjcb;
	//实际成本
	private String sjcb;
	//应收金额
	private String ysje;
	//应收金额本位币
	private String ysjebwb;
	//发票数量
	private String fpsl;
	//发票计量单位
	 ...
	 * 设置：单位实际成本
	 */
	public void setDwsjcb(String dwsjcb) {
		this.dwsjcb = dwsjcb;
	}
	/**
	 * 获取：单位实际成本
	 */
	public String getDwsjcb() {
		return dwsjcb;
	}
	/**
	 * 设置：实际成本
	 */
	public void setSjcb(String sjcb) {
		this.sjcb = sjcb;
	}
	/**
	 * 获取：实际成本
	 ...
	 * 设置：应收金额本位币
	 */
	public void setYsjebwb(String ysjebwb) {
		this.ysjebwb = ysjebwb;
	}
	/**
	 * 获取：应收金额本位币
	 */
	public String getYsjebwb() {
		return ysjebwb;
	}
	/**
	 * 设置：发票数量
	 ...
	 * 设置：发票成本
	 */
	public void setFpcb(String fpcb) {
		this.fpcb = fpcb;
	}
	/**
	 * 获取：发票成本
	 */
	public String getFpcb() {
		return fpcb;
	}
	/**
	 * 设置：未开票数量
