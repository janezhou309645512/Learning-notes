...
public class HttpHelper {
    ...
    public static String sendPostByUrlConnection(String urlStr, Map<String, String> params, String charset) {
        StringBuffer resultBuffer = null;
        // 构建请求参数
        String sbParams = JoiningTogetherParams(params);
    ...
    public static String sendGetByHttpUrlConnection(String urlStr, Map<String, String> params, String charset) {
        StringBuffer resultBuffer = null;
        // 构建请求参数
        String sbParams = JoiningTogetherParams(params);
        HttpURLConnection con = null;
    ...
    public static String sendGetByUrlConnection(String urlStr, Map<String, String> params, String charset) {
        StringBuffer resultBuffer = null;
        // 构建请求参数
        String sbParams = JoiningTogetherParams(params);
        BufferedReader br = null;
    ...
    private static String JoiningTogetherParams(Map<String, String> params) {
        StringBuffer sbParams = new StringBuffer();
        if (params != null && params.size() > 0) {
