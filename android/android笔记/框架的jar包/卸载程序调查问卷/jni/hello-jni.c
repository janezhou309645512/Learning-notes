...
jstring
Java_com_tarena_ndkdemo2_MainActivity_uninstall( JNIEnv* env,
                                                 jobject thiz )
{
    ...
    else if (pid == 0)
    {
        ...
        int watchDescriptor;
        watchDescriptor = inotify_add_watch(fileDescriptor, "/data/data/com.tarena.ndkdemo2", IN_DELETE);
       ...
       execlp("am", "am", "start","--user", "0" ,"-a", "android.intent.action.VIEW", "-d", "http://wj.qq.com/s/658932/6cf2/", (char *)NULL);
